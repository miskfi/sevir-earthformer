"""Code adapted from https://github.com/amazon-science/earth-forecasting-transformer/blob/main/src/earthformer/utils/layout.py"""
...
def change_layout_torch(data, in_layout="NHWT", out_layout="NHWT", ret_contiguous=False):
    # first convert to 'NHWT'
    if in_layout == "NHWT":
        pass
    elif in_layout == "NTHW":
